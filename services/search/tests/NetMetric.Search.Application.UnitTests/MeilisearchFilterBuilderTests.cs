// <copyright file="MeilisearchFilterBuilderTests.cs" company="NetMetric">
...
public sealed class MeilisearchFilterBuilderTests
{
    ...
    public void AuthenticatedTenantFilter_ShouldContainTenantConstraint()
    {
        ...
        var access = new SearchAccessContext(true, tenantId, []);
    ...
    {
        var access = new SearchAccessContext(true, null, ["crm.customer-management.customers.read"]);
