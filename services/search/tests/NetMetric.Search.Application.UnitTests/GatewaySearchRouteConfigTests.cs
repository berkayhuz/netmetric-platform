// <copyright file="GatewaySearchRouteConfigTests.cs" company="NetMetric">
...
public sealed class GatewaySearchRouteConfigTests
{
    ...
    public void GatewayAppsettings_ShouldContainSearchRouteBeforeCrmCatchAll()
    {
        ...
        var appsettingsPath = Path.Combine(repoRoot, "platform", "gateway", "src", "NetMetric.ApiGateway", "appsettings.json");
    ...
    private static string FindRepoRoot()
    {
        ...
        {
            if (File.Exists(Path.Combine(directory.FullName, "NetMetric.slnx")))
            {
