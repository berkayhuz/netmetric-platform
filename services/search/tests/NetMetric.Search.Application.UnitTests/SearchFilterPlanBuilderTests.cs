// <copyright file="SearchFilterPlanBuilderTests.cs" company="NetMetric">
...
public sealed class SearchFilterPlanBuilderTests
{
    ...
    {
        var access = new SearchAccessContext(true, null, []);
    ...
    {
        var noTenantPlan = BuildPlan(new SearchRequest(), new SearchAccessContext(true, null, []));
        var withTenantPlan = BuildPlan(new SearchRequest(), new SearchAccessContext(true, Guid.NewGuid(), []));
    ...
    public void AuthenticatedWithoutTenant_ShouldAllowOnlyGlobalPermissionCandidates()
    {
        var plan = BuildPlan(
            new SearchRequest(),
            new SearchAccessContext(true, null, ["crm.customer-management.customers.read"]));
    ...
    public void AuthenticatedWithTenant_ShouldAllowTenantVisibilityAndPermissionCandidates()
    {
        ...
        var plan = BuildPlan(
            new SearchRequest(),
            new SearchAccessContext(true, tenantId, ["crm.customer-management.customers.read"]));
    ...
    public void IncludeDeleted_ShouldAlwaysBeForcedToFalse()
    {
        ...
        var plan = BuildPlan(request, new SearchAccessContext(true, Guid.NewGuid(), ["crm.read"]));
    ...
    {
        var plan = BuildPlan(new SearchRequest(), new SearchAccessContext(true, Guid.NewGuid(), ["crm.read"]));
