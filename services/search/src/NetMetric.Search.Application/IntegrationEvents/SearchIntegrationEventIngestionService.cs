// <copyright file="SearchIntegrationEventIngestionService.cs" company="NetMetric">
...
using NetMetric.Search.Application.Indexing.Commands;
...
namespace NetMetric.Search.Application.IntegrationEvents;
