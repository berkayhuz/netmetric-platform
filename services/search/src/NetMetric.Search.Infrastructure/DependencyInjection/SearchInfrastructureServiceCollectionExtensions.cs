// <copyright file="SearchInfrastructureServiceCollectionExtensions.cs" company="NetMetric">
...
using NetMetric.Search.Infrastructure.StaticIndexing;

namespace NetMetric.Search.Infrastructure.DependencyInjection;
