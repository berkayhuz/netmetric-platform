// <copyright file="TicketManagementOutboxPublisherTests.cs" company="NetMetric">
...
public sealed class TicketManagementOutboxPublisherTests
{
    [Fact]
    public async Task PublishAsync_Should_Use_Search_Exchange_For_Search_Index_Events()
    {
        ...
        var sut = new RabbitMqTicketManagementOutboxPublisher(inner, options);
