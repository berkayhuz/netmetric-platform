// <copyright file="OpportunityManagementOutboxPublisherTests.cs" company="NetMetric">
...
public sealed class OpportunityManagementOutboxPublisherTests
{
    [Fact]
    public async Task PublishAsync_Should_Use_Search_Exchange_For_Search_Index_Events()
    {
        ...
        var sut = new RabbitMqOpportunityManagementOutboxPublisher(inner, options);
