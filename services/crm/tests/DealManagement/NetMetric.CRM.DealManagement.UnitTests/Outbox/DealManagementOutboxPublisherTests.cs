// <copyright file="DealManagementOutboxPublisherTests.cs" company="NetMetric">
...
public sealed class DealManagementOutboxPublisherTests
{
    [Fact]
    public async Task PublishAsync_Should_Use_Search_Exchange_For_Search_Index_Events()
    {
        ...
        var sut = new RabbitMqDealManagementOutboxPublisher(inner, options);
