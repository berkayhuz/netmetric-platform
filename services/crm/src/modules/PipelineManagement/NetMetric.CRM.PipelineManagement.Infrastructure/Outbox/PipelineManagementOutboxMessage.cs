// <copyright file="PipelineManagementOutboxMessage.cs" company="NetMetric">
...
public sealed class PipelineManagementOutboxMessage
{
    private PipelineManagementOutboxMessage()
    {
    ...
    public static PipelineManagementOutboxMessage Create(
        Guid tenantId,
        string eventName,
        int eventVersion,
        string routingKey,
