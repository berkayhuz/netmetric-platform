// <copyright file="PipelineManagementOutboxMessageConfiguration.cs" company="NetMetric">
...
namespace NetMetric.CRM.PipelineManagement.Infrastructure.Persistence.Configurations;

public sealed class PipelineManagementOutboxMessageConfiguration : IEntityTypeConfiguration<PipelineManagementOutboxMessage>
{
    public void Configure(EntityTypeBuilder<PipelineManagementOutboxMessage> builder)
    {
        builder.ToTable("PipelineManagementOutboxMessages");
