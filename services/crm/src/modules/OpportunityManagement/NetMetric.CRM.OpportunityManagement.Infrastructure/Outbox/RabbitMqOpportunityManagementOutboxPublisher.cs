// <copyright file="RabbitMqOpportunityManagementOutboxPublisher.cs" company="NetMetric">
...
public sealed class RabbitMqOpportunityManagementOutboxPublisher(
    IIntegrationEventPublisher publisher,
    IOptions<RabbitMqOptions> rabbitMqOptions) : IOpportunityManagementOutboxPublisher
{
    private const string SearchExchange = "netmetric.search";

    public Task PublishAsync(OpportunityManagementOutboxMessage message, CancellationToken cancellationToken)
    {
