// <copyright file="OpportunityManagementOutboxMessage.cs" company="NetMetric">
...
public sealed class OpportunityManagementOutboxMessage
{
    private OpportunityManagementOutboxMessage()
    {
    ...
    public static OpportunityManagementOutboxMessage Create(
        Guid tenantId,
        string eventName,
        int eventVersion,
        string routingKey,
