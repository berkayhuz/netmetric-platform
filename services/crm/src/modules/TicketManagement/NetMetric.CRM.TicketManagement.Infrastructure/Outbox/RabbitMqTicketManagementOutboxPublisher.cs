// <copyright file="RabbitMqTicketManagementOutboxPublisher.cs" company="NetMetric">
...
public sealed class RabbitMqTicketManagementOutboxPublisher(
    IIntegrationEventPublisher publisher,
    IOptions<RabbitMqOptions> rabbitMqOptions) : ITicketManagementOutboxPublisher
{
    private const string SearchExchange = "netmetric.search";

    public Task PublishAsync(TicketManagementOutboxMessage message, CancellationToken cancellationToken)
    {
