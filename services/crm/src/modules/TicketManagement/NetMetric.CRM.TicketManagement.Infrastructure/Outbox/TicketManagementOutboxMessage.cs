// <copyright file="TicketManagementOutboxMessage.cs" company="NetMetric">
...
public sealed class TicketManagementOutboxMessage
{
    private TicketManagementOutboxMessage()
    {
    ...
    public static TicketManagementOutboxMessage Create(
        Guid tenantId,
        string eventName,
        int eventVersion,
        string routingKey,
