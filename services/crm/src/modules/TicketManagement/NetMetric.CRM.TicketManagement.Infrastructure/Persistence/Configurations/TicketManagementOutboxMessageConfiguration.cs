// <copyright file="TicketManagementOutboxMessageConfiguration.cs" company="NetMetric">
...
public sealed class TicketManagementOutboxMessageConfiguration : IEntityTypeConfiguration<TicketManagementOutboxMessage>
{
    public void Configure(EntityTypeBuilder<TicketManagementOutboxMessage> builder)
    {
        builder.ToTable("TicketManagementOutboxMessages");
