// <copyright file="QuoteManagementOutboxMessageConfiguration.cs" company="NetMetric">
...
public sealed class QuoteManagementOutboxMessageConfiguration : IEntityTypeConfiguration<QuoteManagementOutboxMessage>
{
    public void Configure(EntityTypeBuilder<QuoteManagementOutboxMessage> builder)
    {
        builder.ToTable("QuoteManagementOutboxMessages");
