// <copyright file="LeadManagementOutboxMessageConfiguration.cs" company="NetMetric">
...
public sealed class LeadManagementOutboxMessageConfiguration : IEntityTypeConfiguration<LeadManagementOutboxMessage>
{
    public void Configure(EntityTypeBuilder<LeadManagementOutboxMessage> builder)
    {
        builder.ToTable("LeadManagementOutboxMessages");
