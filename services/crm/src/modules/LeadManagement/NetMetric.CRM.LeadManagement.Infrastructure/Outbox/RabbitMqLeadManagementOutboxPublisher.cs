// <copyright file="RabbitMqLeadManagementOutboxPublisher.cs" company="NetMetric">
...
public sealed class RabbitMqLeadManagementOutboxPublisher(
    IIntegrationEventPublisher publisher,
    IOptions<RabbitMqOptions> rabbitMqOptions) : ILeadManagementOutboxPublisher
{
    private const string SearchExchange = "netmetric.search";

    public Task PublishAsync(LeadManagementOutboxMessage message, CancellationToken cancellationToken)
    {
