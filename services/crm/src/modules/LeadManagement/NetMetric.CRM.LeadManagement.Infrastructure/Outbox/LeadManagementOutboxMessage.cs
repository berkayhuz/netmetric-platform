// <copyright file="LeadManagementOutboxMessage.cs" company="NetMetric">
...
public sealed class LeadManagementOutboxMessage
{
    private LeadManagementOutboxMessage()
    {
    ...
    public static LeadManagementOutboxMessage Create(
        Guid tenantId,
        string eventName,
        int eventVersion,
        string routingKey,
