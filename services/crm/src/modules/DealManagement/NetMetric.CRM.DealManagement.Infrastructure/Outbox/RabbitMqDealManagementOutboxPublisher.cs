// <copyright file="RabbitMqDealManagementOutboxPublisher.cs" company="NetMetric">
...
public sealed class RabbitMqDealManagementOutboxPublisher(
    IIntegrationEventPublisher publisher,
    IOptions<RabbitMqOptions> rabbitMqOptions) : IDealManagementOutboxPublisher
{
    private const string SearchExchange = "netmetric.search";

    public Task PublishAsync(DealManagementOutboxMessage message, CancellationToken cancellationToken)
    {
