// <copyright file="DealManagementOutboxMessage.cs" company="NetMetric">
...
public sealed class DealManagementOutboxMessage
{
    private DealManagementOutboxMessage()
    {
    ...
    public static DealManagementOutboxMessage Create(
        Guid tenantId,
        string eventName,
        int eventVersion,
        string routingKey,
