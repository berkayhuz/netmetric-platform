// <copyright file="DealManagementOutboxMessageConfiguration.cs" company="NetMetric">
...
public sealed class DealManagementOutboxMessageConfiguration : IEntityTypeConfiguration<DealManagementOutboxMessage>
{
    public void Configure(EntityTypeBuilder<DealManagementOutboxMessage> builder)
    {
        builder.ToTable("DealManagementOutboxMessages");
